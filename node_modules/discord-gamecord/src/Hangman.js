...
module.exports = class Hangman extends events {
  ...
  handleButtons(msg) {
    ...
    collector.on('collect', async btn => {
      ...
      .addFields({ name: `Palabra (${this.word.length})`, value: this.getWordEmojis() });
  ...
  gameOver(msg, result) {
    ...
    embed.addFields({ name: '⏱️ Juego terminado', value: GameOverMessage.replace('{word}', this.word.toUpperCase()) });
