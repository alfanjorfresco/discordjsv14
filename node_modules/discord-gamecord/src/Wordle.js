...
module.exports = class Wordle extends events {
  constructor(options = {}) {
    ...
    if (!options.embed.description) options.embed.description = '';
    ...
    if (typeof options.embed.description !== 'string') throw new TypeError('INVALID_EMBED: embed title must be a string.');
  ...
  async gameOver(msg) {
    ...
    .setTitle(this.options.embed.title)
    .setImage('attachment://wordle.png')
    .addFields({ name: '⏱️ Juego Terminado', value: GameOverMessage.replace('{word}', this.word) })
